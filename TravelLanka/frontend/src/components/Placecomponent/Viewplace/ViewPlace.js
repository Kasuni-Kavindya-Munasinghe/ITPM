    ...
    render(){
        return(
            ...
            <div className="IntContainer">
                ...
                <button type="submit" class="btn btn-primary" onClick={this.onSearch}>Search Place</button>
                <button type="submit" class="btn btn-primary" onClick={this.onSubmitAdd} >Add New Place</button><br></br><br></br>
